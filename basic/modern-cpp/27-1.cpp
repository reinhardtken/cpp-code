...
template<class T> bool is_same_value2(T a, T b)
{
...
void ModernCppTest271() {
...

    {
        double x = 0.1 + 0.1 + 0.1 - 0.3;
        std::cout << std::boolalpha;
        std::cout << "is_same_value2(5, 5)	: " << is_same_value2(5, 5) << std::endl;
        std::cout << "x == 0.0			: " << (x == 0.) << std::endl;
        std::cout << "is_same_value2(x, 0.)	: " << is_same_value2(x, 0.) << std::endl;
    }
